...
# Ce chemin est hardcodé à des fins de tests ; il faut exécuter l'interface graphique pour choisir le fichier de log à analyser ou l'exécutable créé via la distribution
    ...
    with open(log_file, "r", encoding="utf-8") as file:
        ...
        for line in file:
            ...
            if item or money:
                ...
                if money and current_monster is not None:
